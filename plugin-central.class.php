	...
	class PluginCentral {
		...
		function dash() {
			...
			if (!empty($update_plugins->response)) {
				foreach ($plugins as $file => $p) {
					...
					if (in_array($file, (array)$options)) {
						continue;
					}
		...
		function display_info_row($file) {
			...
			if (!is_wp_error($api) && current_user_can('update_plugins')) {
				...
				$class_tr = version_compare($wp_version, '2.7.999', '>') ? ' class="plugin-update-tr second ' . $class . '"' : '';
		...
		function dash_install() {
			...
			?>
			<form id="extra" name="form_apu" method="post"
				  action="plugins.php?page=plugin-central/plugin-central.class.php">
				...
				<div class="submit">
					...
					<p><a href="plugins.php?page=plugin-central/plugin-central.class.php">Install multiple plugins</a>
					</p>
				</div>
			</form>
			<?php
		 ...
		 * @param           $dir_from
		 * @param           $dir_to
		 * @param bool|TRUE $include_sub_dirs
		 *
		 * @return bool
		 */
		...
		function options_page() {
			...
			<div class="wrap pc-wrap">
				...
				<div id="poststuff" style="margin-top:10px;">
					<div id="sideblock" style="float:right;width:270px;margin-left:10px;">
						...
						<div class="ad">
							<a href="https://managewp.com/?utm_source=Plugins&amp;utm_medium=Banner&amp;utm_content=mwp250_2&amp;utm_campaign=PluginCentral"
							   title="ManageWP.com - Manage your sites from one dashboard"><img
										src="<?php echo $imgpath; ?>mwp250_2.png"
										alt="ManageWP.com - Manage Multiple WordPress Sites"></a>
						</div>
            ...
            <a href="plugins.php?page=plugin-central/plugin-central.class.php&_wpnonce=%s&pc_no_ignore=%s">%s</a>
								...
								?>
								<h2>Options</h2>
								<input class="button" type="submit" name="apu_all" value="List all plugins"
									   class="button-primary"/>
								<input class="button" type="submit" name="apu_active" value="List active plugins"
									   class="button-primary"/>
								<?php echo $result ?>
                                ...
                                <textarea style="border:1px solid #D1D1D1;width:600px;" name="multi_plugins"
										  id="multi_plugins" cols="40" rows="10"></textarea>

									<p><input class="button" type="submit" name="apu_update"
											  value="Install plugins &raquo;"
			...
			<h5 class="author">Another fine plugin by <a href="http://www.prelovac.com/vladimir/">Vladimir Prelovac</a>
			</h5>
